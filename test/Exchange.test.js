...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
  ...
  describe('withdrawing Ether', async () => {
    ...
    let amount
    beforeEach(async () => {
      // Deposit Ether to the exchange First
      amount = ether(1)
    ...
    describe('failure', async () => {
      it('rejects withdraws for insuficient balances', async () => {
  ...
  describe('depositing tokens', () => {
    ...
    describe('failure', () => {
      ...
      it('fails when no tokens are approved', async () => {
        // Not approving any tokens before trying to deposit
    ...
    describe('filling orders', async () => {
      ...
      describe('success', async () => {
        ...
        it('executes the trade and charges fees', async () => {
          ...
          balance.toString().should.equal(tokens(0.1).toString(), 'feeAccount received the fee')
        })
